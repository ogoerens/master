...
public class OldQueries {
    ...
    public static Query q0d =
            new Query("SELECT * FROM customer_mktsegBinomial WHERE c_mktsegment = 'Furniture'", "q0d");
    ...
    public static Query q0i =
            new Query("SELECT * FROM customer_mktsegBinomial WHERE c_mktsegment = 'Automobile'", "q0i");
    ...
    public static Query q0k =
            new Query("SELECT * FROM customer_mktsegBinomial WHERE c_mktsegment = 'Machinery'", "q0k");
    ...
    public static Query q1e =
            new Query("SELECT * FROM  customer_nationkeyBinomial2   WHERE c_nationkey = 17", "q1e");
    public static Query q1f =
            new Query("SELECT * FROM  customer_nationkeyBinomial3   WHERE c_nationkey = 9", "q1f");
    ...
    public static String qq5 =
            "SELECT  count(*) " + "FROM customer_uncorrelated " + "Group by corr1/%1$s, corr2/%1$s";
    public static Query q5 =
            new Query(
                    "SELECT  count(*) " + "FROM customer_uncorrelated " + "Group by corr1/5, corr2/5", "q5");
    ...
    public static String qq6 = "SELECT * FROM customer_uncorrelated WHERE corr1 > %s and corr2 > %s";
    ...
    public static Query q7a =
            new Query(
                    "SELECT distinct c_nationkey FROM customer_largerNation Where c_custkey%2!=0", "q7a");
    public static Query q7b =
            new Query(
                    "Select distinct c_nationkey FROM customer_smallerNation Where c_custkey%2!=0", "q7b");
