...
public class Queries {
  ...
  public static String q0e = "SELECT * " + "FROM customer_bloatedmktseg " + "WHERE c_mktsegBloated = 'Furniture%'";
  ...
  public static String[] queryList = {
    ...
    q5a, q5b, q6, q6a, q6b, q7, q7a, q7b, q8, q8a, q9, q9a, q10, q10a, q10b
  };
