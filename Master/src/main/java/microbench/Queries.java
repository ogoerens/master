...
public class Queries {
  ...
  public static String q0e = "SELECT * " + "FROM customer_bloatedmktseg " + "WHERE c_mktsegBloated like '%iture'";
  ...
  public static String q1d = "SELECT * FROM  customer_nationkeyBinomial   WHERE c_nationkeyBinomial = 10";
  public static String q1e = "SELECT * FROM  customer_nationkeyBinomial2   WHERE c_nationkeyBinomial = 10";
  public static String q1f = "SELECT * FROM  customer_nationkeyBinomial3   WHERE c_nationkeyBinomial = 10";
  ...
  public static String q6a =
      "SELECT * FROM customer_correlated WHERE corr1 > 20 and corr2 > 40";
  ...
  public static String q10b = "SELECT * FROM customer_commentFixedSize where c_comment like '%regular%'";
  //Queries with Index
  ...
  public static String q12a= "SELECT DISTINCT(c_custkeyNonDistinct)FROM CustomerClusteredIndex_custkeyNonDistinct";


  public static String[] queryList = {
    q0, q0a, q0b, q0c, q0d, q0e, q1, q1a, q1b, q1c, q1d, q1e, q1f, q2, q2a, q2b, q3, q3a, q3b, q3c, q4, q4a, q4b, q5,
    q5a, q5b, q6, q6a, q6b, q7, q7a, q7b, q8, q8a, q9, q9a, q10, q10a, q10b, q11, q11a, q11b, q12, q12a
  };
  public static String[] queryListNames = {
    "q0", "q0a", "q0b", "q0c", "q0d", "q0e", "q1", "q1a", "q1b", "q1c","q1d", "q1e","q1f", "q2", "q2a", "q2b", "q3", "q3a",
    "q3b", "q3c", "q4", "q4a", "q4b", "q5", "q5a", "q5b", "q6", "q6a", "q6b", "q7", "q7a", "q7b",
    "q8", "q8a", "q9", "q9a", "q10", "q10a", "q10b", "q11", "q11a", "q11b", "q12", "q12a"
  };
}
