...
def MST(data, epsilon, delta):
    ...
    tuple1 = ('CORR1','CORR2')
    #tuple2 = ('C_NATIONKEY','C_PHONE')

    #cliques = list()
    cliques.append(tuple1)
    #cliques.append(tuple2)
...
def measure(data, cliques, sigma, weights=None):
    ...
    for proj, wgt in zip(cliques, weights):
        ...
        Q = sparse.eye(x.size)
        #measurements.append( (Q, x, sigma/wgt, proj) )
...
if __name__ == '__main__':
    ...
    #workload = list();
    #workload.append(tuple1)
    #workload.append(tuple2)
